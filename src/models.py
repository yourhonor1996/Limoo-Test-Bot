...
class Thread(models.Model):
    # TODO we can change this to tinyint so it takes less space, but we have to change the end state for conversation to 0
    ...
    webhook_token = models.CharField(max_length= 100, null= True, blank= True)
